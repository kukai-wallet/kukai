...
fs.readFile(f, 'utf8', function (err, data) {
  ...
  if (data.indexOf('new webpack.IgnorePlugin(/^\.\/locale$/, /moment$/)') === -1) {
    ...
    result.replace('...extraPlugins', 'new webpack.IgnorePlugin(/^\.\/locale$/, /moment$/), ...extraPlugins');
    result.replace('const plugins_1 = require("../plugins");', 'const webpack = require("webpack"); const plugins_1 = require("../plugins");');
