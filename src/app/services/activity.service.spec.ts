...
describe('[ ActivityService ]', () => {
	...
	beforeEach(() => { 
		...
		TestBed.configureTestingModule({
			...
			providers: [ActivityService, WalletService, MessageService, TzscanService, TranslateService, OperationService, EncryptionService, ErrorHandlingPipe]
		});
	...
	it('should get the index of account pkh', () => {
		let index = service.getIndex('KT1contract1');
		expect(index).toBe(1);
