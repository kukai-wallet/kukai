...
describe('EstimateService', () => {
  ...
  describe('> Estimate limits/cost for transactions ', () => {
    it('Should estimate batch transaction', async function () {
      ...
      await service.estimate(JSON.parse('[{"to":"tz1LcuQHNVQEWP2fZjk1QYZGNrfLDwrT3SyZ","amount":3,"gasLimit":0,"storageLimit":0},{"to":"KT1NXwhVgf7Ge7iS9bCUzMNVJeeB1Eni5kVS","amount":5,"gasLimit":0,"storageLimit":0},{"to":"tz1TwVimQy3BywXoSszdFXjT9bSTQrsZYo2u","amount":7,"gasLimit":0,"storageLimit":0}]'), 'tz1aUxrUek1tSCP4pTPLrSNhYGSMdwyzuYTb', callback);
      const ref = {
        customLimits: [{
          gasLimit: 10287,
          storageLimit: 0
