...
describe('[ ImportService ]', () => {
  ...
  const hd = {
    ...
    keyStore: {
      ...
      walletType: 4,
      encryptedSeed:
        '90f57ef8f82e9acfa11a44e02aefaa8444596c3a8d2aa2aeaecfbb51187484a0354bf8a6c009bb4836716dc030d790978948044454dd85e6e2f2fb6284ac2c50==a533b34b90fcf71742a0d6abc9eaed15',
  ...
  describe('> Import Wallet', () => {
    ...
    describe('> Import Full Wallet', () => {
      ...
      it('should import full wallet v2', async () => {
        spyOn(indexer, 'getContractAddresses').and.callFake(async function () {
          return [];
        });
    ...
    describe('> Legacy v3', async () => {
      beforeEach(() => {
        ...
        spyOn(indexer, 'accountInfo').and.callFake(async function () {
          return 0;
        });
        wallet.wallet = null;
      });
    ...
    describe('> HD', async () => {
      ...
      beforeEach(() => {
        ...
        spyOn(indexer, 'isUsedAccount').and.callFake(async function () {
          return numberOfAccounts-- > 0 ? true : false;
        });
      });
